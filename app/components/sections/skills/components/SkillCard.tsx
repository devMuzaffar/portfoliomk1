...
const SkillCard = ({ title, icons, classNames, animateFrom }: skillProps) => {
  return (
    <div
      ...
      className={`animate glass-effect rounded-xl flex flex-col p-2 gap-2 border-[1px] border-gray-400 dark:border-gray-600 hover:shadow-lg hover:border-primary hover:dark:border-primary hover:shadow-primary/30 hover:dark:shadow-primary/30  hover:-translate-y-1 ${classNames}`}
    >
      {/* Title */}
